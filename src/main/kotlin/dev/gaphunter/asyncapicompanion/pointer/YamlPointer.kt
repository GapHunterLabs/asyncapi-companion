 ...
 * counterpart of [JsonPointer], needed because AsyncAPI documents are
 * written in YAML at least as often as JSON in practice.
 * [org.jetbrains.yaml.psi.YAMLMapping.getKeyValueByKey] does the exact
 * per-segment lookup [JsonObject.findProperty] does for JSON.
 */
object YamlPointer {
