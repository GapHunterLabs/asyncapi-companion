package dev.gaphunter.asyncapicompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.asyncapicompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.asyncapicompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "AsyncAPI Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33389-asyncapi-companion/reviews"
