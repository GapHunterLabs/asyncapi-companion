...
dependencies {
    ...
    intellijPlatform {
        ...
        // AsyncAPI specs are written in JSON or YAML interchangeably --
        // both bundled PSI providers are needed, same call as
        // openapi-companion (confirmed real ids there via javap/plugin.xml
